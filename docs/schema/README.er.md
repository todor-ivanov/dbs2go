...
erDiagram
  ACQUISITION_ERAS {
    INTEGER ACQUISITION_ERA_ID PK
    VARCHAR2_120 ACQUISITION_ERA_NAME UK
    INTEGER START_DATE
    INTEGER END_DATE
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
    VARCHAR2_40 DESCRIPTION
  }
  APPLICATION_EXECUTABLES {
    INTEGER APP_EXEC_ID PK
    VARCHAR2_100 APP_NAME UK
  }
  ASSOCIATED_FILES {
    INTEGER ASSOCATED_FILE_ID PK
    INTEGER THIS_FILE_ID FK, UK
    INTEGER ASSOCATED_FILE FK, UK
  }
  BLOCKS {
    INTEGER BLOCK_ID PK
    VARCHAR2_500 BLOCK_NAME UK
    INTEGER DATASET_ID FK
    INTEGER OPEN_FOR_WRITING
    VARCHAR2_200 ORIGIN_SITE_NAME
    INTEGER BLOCK_SIZE
    INTEGER FILE_COUNT
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
    INTEGER LAST_MODIFICATION_DATE
    VARCHAR2_500 LAST_MODIFIED_BY
  }
  BLOCK_PARENTS {
    INTEGER THIS_BLOCK_ID PK, FK
    INTEGER PARENT_BLOCK_ID PK, FK
  }
  BRANCH_HASHES {
    INTEGER BRANCH_HASH_ID PK
    VARCHAR2_700 BRANCH_HASH
    CLOB CONTENT
  }
  DATASETS {
    INTEGER DATASET_ID PK
    VARCHAR2_700 DATASET UK
    INTEGER IS_DATASET_VALID
    INTEGER PRIMARY_DS_ID FK
    INTEGER PROCESSED_DS_ID FK
    INTEGER DATA_TIER_ID FK
    INTEGER DATASET_ACCESS_TYPE_ID FK
    INTEGER ACQUISITION_ERA_ID FK
    INTEGER PROCESSING_ERA_ID FK
    INTEGER PHYSICS_GROUP_ID FK
    FLOAT_126 XTCROSSSECTION
    VARCHAR2_256 PREP_ID
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
    INTEGER LAST_MODIFICATION_DATE
    VARCHAR2_500 LAST_MODIFIED_BY
  ...
  DATASET_ACCESS_TYPES {
    INTEGER DATASET_ACCESS_TYPE_ID PK
    VARCHAR2_100 DATASET_ACCESS_TYPE UK
  }
  DATASET_OUTPUT_MOD_CONFIGS {
    INTEGER DS_OUTPUT_MOD_CONF_ID PK
    INTEGER DATASET_ID FK, UK
    INTEGER OUTPUT_MOD_CONFIG_ID FK, UK
  }
  DATASET_PARENTS {
    INTEGER THIS_DATASET_ID PK, FK
    INTEGER PARENT_DATASET_ID PK, FK
  }
  DATASET_RUNS {
    INTEGER DATASET_RUN_ID PK
    INTEGER DATASET_ID FK
    INTEGER RUN_NUMBER
    INTEGER COMPLETE
    INTEGER LUMI_SECTION_COUNT
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
  }
  DATA_TIERS {
    INTEGER DATA_TIER_ID PK
    VARCHAR2_100 DATA_TIER_NAME UK
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
  }
  DBS_VERSIONS {
    INTEGER DBS_VERSION_ID PK
    VARCHAR2_40 SCHEMA_VERSION
    VARCHAR2_40 DBS_RELEASE_VERSION
    VARCHAR2_40 INSTANCE_NAME
    VARCHAR2_40 INSTANCE_TYPE
    INTEGER CREATION_DATE
    INTEGER LAST_MODIFICATION_DATE
  }
  FILES {
    INTEGER FILE_ID PK
    VARCHAR2_500 LOGICAL_FILE_NAME UK
    INTEGER IS_FILE_VALID
    INTEGER DATASET_ID FK
    INTEGER BLOCK_ID FK
    INTEGER FILE_TYPE_ID FK
    VARCHAR2_100 CHECK_SUM
    INTEGER EVENT_COUNT
    INTEGER FILE_SIZE
    INTEGER BRANCH_HASH_ID FK
    VARCHAR2_100 ADLER32
    VARCHAR2_100 MD5
    FLOAT_126 AUTO_CROSS_SECTION
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
    INTEGER LAST_MODIFICATION_DATE
    VARCHAR2_500 LAST_MODIFIED_BY
  ...
  FILE_DATA_TYPES {
    INTEGER FILE_TYPE_ID PK
    VARCHAR2_100 FILE_TYPE UK
  }
  FILE_LUMIS {
    INTEGER RUN_NUM PK
    INTEGER LUMI_SECTION_NUM PK
    INTEGER FILE_ID PK, FK
    INTEGER EVENT_COUNT
  }
  FILE_OUTPUT_MOD_CONFIGS {
    INTEGER FILE_OUTPUT_CONFIG_ID PK
    INTEGER FILE_ID FK, UK
    INTEGER OUTPUT_MOD_CONFIG_ID FK, UK
  }
  FILE_PARENTS {
    INTEGER THIS_FILE_ID PK, FK
    INTEGER PARENT_FILE_ID PK, FK
  }
  MIGRATION_BLOCKS {
    INTEGER MIGRATION_BLOCK_ID PK
    INTEGER MIGRATION_REQUEST_ID FK, UK
    VARCHAR2_700 MIGRATION_BLOCK_NAME UK
    INTEGER MIGRATION_ORDER
    INTEGER MIGRATION_STATUS
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
    INTEGER LAST_MODIFICATION_DATE
    VARCHAR2_500 LAST_MODIFIED_BY
  ...
  MIGRATION_REQUESTS {
    INTEGER MIGRATION_REQUEST_ID PK
    VARCHAR2_300 MIGRATION_URL
    VARCHAR2_700 MIGRATION_INPUT UK
    INTEGER MIGRATION_STATUS
    VARCHAR2_100 MIGRATION_SERVER
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
    INTEGER LAST_MODIFICATION_DATE
    VARCHAR2_500 LAST_MODIFIED_BY
  ...
  OUTPUT_MODULE_CONFIGS {
    INTEGER OUTPUT_MOD_CONFIG_ID PK
    INTEGER APP_EXEC_ID FK, UK
    INTEGER RELEASE_VERSION_ID FK, UK
    INTEGER PARAMETER_SET_HASH_ID FK, UK
    VARCHAR2_100 OUTPUT_MODULE_LABEL UK
    VARCHAR2_255 GLOBAL_TAG UK
    VARCHAR2_40 SCENARIO
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
  }
  PARAMETER_SET_HASHES {
    INTEGER PARAMETER_SET_HASH_ID PK
    VARCHAR2_128 PSET_HASH UK
    VARCHAR2_135 PSET_NAME
  }
  PHYSICS_GROUPS {
    INTEGER PHYSICS_GROUP_ID PK
    VARCHAR2_100 PHYSICS_GROUP_NAME UK
  }
  PRIMARY_DATASETS {
    INTEGER PRIMARY_DS_ID PK
    VARCHAR2_100 PRIMARY_DS_NAME UK
    INTEGER PRIMARY_DS_TYPE_ID FK
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
  }
  PRIMARY_DS_TYPES {
    INTEGER PRIMARY_DS_TYPE_ID PK
    VARCHAR2_100 PRIMARY_DS_TYPE UK
  }
  PROCESSED_DATASETS {
    INTEGER PROCESSED_DS_ID PK
    VARCHAR2_235 PROCESSED_DS_NAME UK
  }
  PROCESSING_ERAS {
    INTEGER PROCESSING_ERA_ID PK
    INTEGER PROCESSING_VERSION UK
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
    VARCHAR2_40 DESCRIPTION
  }
  RELEASE_VERSIONS {
    INTEGER RELEASE_VERSION_ID PK
    VARCHAR2_100 RELEASE_VERSION UK
  }
  FILES ||--o{ ASSOCIATED_FILES : "FL_AF / CASCADE"
  FILES ||--o{ ASSOCIATED_FILES : "FL_AF2 / CASCADE"
  DATASETS ||--o{ BLOCKS : "DS_BK / CASCADE"
  BLOCKS ||--o{ BLOCK_PARENTS : "BK_BP / CASCADE"
  BLOCKS ||--o{ BLOCK_PARENTS : "BK_BP2 / CASCADE"
  ACQUISITION_ERAS ||--o{ DATASETS : "AQE_DS / SET NULL"
  DATASET_ACCESS_TYPES ||--o{ DATASETS : "DTP_DS / NO ACTION"
  DATA_TIERS ||--o{ DATASETS : "DT_DS / CASCADE"
  PRIMARY_DATASETS ||--o{ DATASETS : "PDS_DS / CASCADE"
  PROCESSING_ERAS ||--o{ DATASETS : "PE_DS / SET NULL"
  PHYSICS_GROUPS ||--o{ DATASETS : "PG_DS / SET NULL"
  PROCESSED_DATASETS ||--o{ DATASETS : "PSDS_DS / CASCADE"
  DATASETS ||--o{ DATASET_OUTPUT_MOD_CONFIGS : "DS_DC / CASCADE"
  OUTPUT_MODULE_CONFIGS ||--o{ DATASET_OUTPUT_MOD_CONFIGS : "OMC_DC / CASCADE"
  DATASETS ||--o{ DATASET_PARENTS : "DS_DP / CASCADE"
  DATASETS ||--o{ DATASET_PARENTS : "DS_DP2 / CASCADE"
  DATASETS ||--o{ DATASET_RUNS : "DS_DR / CASCADE"
  BRANCH_HASHES ||--o{ FILES : "BH_FL / SET NULL"
  BLOCKS ||--o{ FILES : "BK_FL / CASCADE"
  DATASETS ||--o{ FILES : "DS_FL / CASCADE"
  FILE_DATA_TYPES ||--o{ FILES : "FT_FL / NO ACTION"
  FILES ||--o{ FILE_LUMIS : "FL_FLM / CASCADE"
  FILES ||--o{ FILE_OUTPUT_MOD_CONFIGS : "FL_FC / CASCADE"
  OUTPUT_MODULE_CONFIGS ||--o{ FILE_OUTPUT_MOD_CONFIGS : "OMC_FC / CASCADE"
  FILES ||--o{ FILE_PARENTS : "FL_FP / CASCADE"
  FILES ||--o{ FILE_PARENTS : "FL_FP2 / CASCADE"
  MIGRATION_REQUESTS ||--o{ MIGRATION_BLOCKS : "MR_MB / CASCADE"
  APPLICATION_EXECUTABLES ||--o{ OUTPUT_MODULE_CONFIGS : "AE_OMC / CASCADE"
  PARAMETER_SET_HASHES ||--o{ OUTPUT_MODULE_CONFIGS : "PSH_OMC / CASCADE"
  RELEASE_VERSIONS ||--o{ OUTPUT_MODULE_CONFIGS : "RV_OMC / CASCADE"
  PRIMARY_DS_TYPES ||--o{ PRIMARY_DATASETS : "PDT_PDS / NO ACTION"
```
</details>
...
erDiagram
  ...
  DATASETS {
    ...
    VARCHAR2_700 DATASET UK
    INTEGER IS_DATASET_VALID
    INTEGER PRIMARY_DS_ID
    INTEGER PROCESSED_DS_ID
    INTEGER DATA_TIER_ID
    INTEGER DATASET_ACCESS_TYPE_ID
    INTEGER ACQUISITION_ERA_ID
    INTEGER PROCESSING_ERA_ID
    INTEGER PHYSICS_GROUP_ID
    FLOAT_126 XTCROSSSECTION
    VARCHAR2_256 PREP_ID
    INTEGER CREATION_DATE
    VARCHAR2_500 CREATE_BY
