...
Selected visualizations: **full, er** · layout: **compact**.
...
Mermaid ER notation is compact and familiar. Relationships attach to entities; use the key or domain maps when exact row endpoints are required.
