...
Selected visualizations: **full, keys** · layout: **compact**.
...
Non-relational columns are folded into the table dictionary, making this view substantially smaller than the full flowchart.
...
flowchart TB
  ...
  style n_sg_DBS_VERSIONS fill:#E8F4F5,stroke:#147887,color:#1f2937
  subgraph n_sg_FILES["FILES · PK PK_FL · +11 folded"]
    direction TB
    n_FILES__FILE_ID["FILE_ID<br/>INTEGER · PK · NN"]
    n_FILES__LOGICAL_FILE_NAME["LOGICAL_FILE_NAME<br/>VARCHAR2(500) · UQ · NN"]
    n_FILES__DATASET_ID["DATASET_ID<br/>INTEGER · FK · NN"]
